...
def main(args):
    ...
    assert args.image_path is not None, "Please provide a path to an image."
    ...
    state_dict = torch.load(ckpt_path, map_location="cuda", weights_only=False)#find_model(ckpt_path)
    ...
    save_image(samples, "sample.png", normalize=True, value_range=(-1, 1))
